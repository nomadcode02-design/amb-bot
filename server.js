...
app.post('/api/reservar', async (req, res) => {
  try {
    ...
    // REGLA: el cliente SIEMPRE tiene que escribirle al bot para recibir su
    // confirmación, sin excepción — aunque la ventana de WhatsApp ya esté
    // abierta con ese número (por ejemplo, en pruebas). No se manda nada
    // acá al crear la reserva; la confirmación sale únicamente cuando llega
    // su mensaje real (ver setOnMensaje más abajo).
